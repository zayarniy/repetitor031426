...
//Проведенных занятий на выбранную неделю
$stmt = $pdo->prepare("
    SELECT COUNT(*) FROM lessons l
    JOIN students s ON l.student_id = s.id
    WHERE s.user_id = ? AND l.lesson_date BETWEEN ? AND ? AND s.is_active = 1 AND l.is_completed = 1
");
$stmt->execute([$userId, $weekStart, $weekEnd]);
$weeklyCompletedLessons = $stmt->fetchColumn();
...
$stmt = $pdo->prepare("
    SELECT COUNT(*) FROM lessons l
    JOIN students s ON l.student_id = s.id
    WHERE s.user_id = ? AND l.lesson_date = ? AND s.is_active = 1 AND l.is_cancelled = 0 AND l.is_completed= 0
");
...
<head>
    ...
    <style>
        ...
        /* На очень маленьких экранах разрешаем перенос текста */
...
<body>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="stats-adaptive-grid">
            ...
            <div class="stat-card-compact">
                <div class="stat-value"><?php echo $weeklyCompletedLessons; ?></div>
            ...
            <div class="filter-panel" id="filterPanel" style="display: none;">
                <form method="GET" action="" id="filterForm">
                    ...
                    <div class="filters-grid">
                        ...
                        <div class="filter-item">
                            ...
                            <select name="status" class="form-select" onchange="this.form.submit()">
                                <option value="active" <?php echo $statusFilter == 'active' ? 'selected' : ''; ?>>Активные
                                </option>
                        ...
                        <div class="filter-item">
                            ...
                            <select name="lesson_status" class="form-select" onchange="this.form.submit()">
                                <option value="all" <?php echo $lessonStatusFilter == 'all' ? 'selected' : ''; ?>>Все
                                </option>
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="dashboard.php<?php echo $weekOffset != 0 ? '?week_offset=' . $weekOffset : ''; ?>"
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="mb-3">
                    ...
                    <?php if ($weekOffset != 0): ?>
                        <small class="text-muted">(<?php echo $weekOffset > 0 ? '+' . $weekOffset : $weekOffset; ?>
                            неделя)</small>
                    <?php endif; ?>
                </h3>
            </div>
                                                ...
                                                <div class="lesson-categories mt-1">
                                                    <?php foreach ($topicCategories as $category): ?>
                                                        <span class="category-badge"
                                                            style="background-color: <?php echo $category['color']; ?>20; border-left: 3px solid <?php echo $category['color']; ?>; padding: 2px 8px; margin-right: 4px; margin-bottom: 2px; display: inline-block; border-radius: 12px; font-size: 0.7rem;">
                                            ...
                                            <div class="row g-1">
                                                <div class="col-6">
                                                    <a href="lessons.php?diary_id=<?php echo $lesson['diary_id']; ?>"
                                                        class="btn btn-sm btn-outline-primary w-100 p-1" style="height: 30px;"
                                                        data-bs-toggle="tooltip" title="Занятия дневника">
                                                ...
                                                <div class="col-6">
                                                    <a href="students.php?action=view&id=<?php echo $lesson['student_id']; ?>"
                                                        ...
                                                        data-bs-toggle="tooltip" title="Ученик">
                                                ...
                                                <div class="col-6">
                                                    <a href="lessons.php?action=edit&id=<?php echo $lesson['id']; ?>&diary_id=<?php echo $lesson['diary_id']; ?>"
                                                        class="btn btn-sm btn-outline-warning w-100 p-1" style="height: 30px;"
                                                ...
                                                <?php if ($hasPublicLink): ?>
                                                    <div class="col-6">
                                                        <a href="public_diary.php?token=<?php echo $diaryInfo['public_link']; ?>"
                                                            target="_blank" class="btn btn-sm btn-outline-success w-100 p-1"
                                                            style="height: 30px;" data-bs-toggle="tooltip" title="Публичная ссылка">
